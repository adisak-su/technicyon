...
<head>
    ...
    <link rel="stylesheet" href="../includes/sidebar/sidebar.css?<?php echo time(); ?>">
...
<body class="sidebar-collapse">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <label class="m-0 text-dark">จัดการยี่ห้อ/รุ่นรถ</label>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <label class="mr-auto" style="line-height: 2.1rem">รายการยี่ห้อ/รุ่นรถ</label>
                                    ...
                                    <div class="container" style="max-width:90%;">
                                        <div class="row">
                                            <div class="col-9 col-lg-6 col-xl-3">
                                                <input type="text" id="searchInput" class="inputStyle inputStyleIcon inputStyleFind cursorHand" placeholder="ชื่อ..." autocomplete="off">
                                            </div>
    ...
    <!-- <script src="../../assets/js/adminlte.js?<?php echo time(); ?>"></script> -->
    ...
    <script src="../includes/sidebar/sidebar.js?<?php echo time(); ?>"></script>
    <script src="../includes/common.js?<?php echo time(); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        async function loadAndSetData(storeName) {
            ...
            // groupNames = dataStore.map((item,index) => { return {"index":index , "groupname":item.groupname,"updatedAt":item.updatedAt}; });
            renderTable();
        }
        ...
        async function _prepareDelete(deleteId, deleteName) {
            message = `${deleteName}<BR>คุณแน่ใจหรือไม่...ที่จะลบรายการนี้?`;
            confirm = await sweetConfirmDelete(message, "ใช่! ลบเลย");
            if (confirm) {
                loaderScreen("show");
        ...
        function renderTable() {
            ...
            if (searchText) {
                filtered = filtered.filter(m =>
                    // m.itemId.toLowerCase().includes(searchText) ||
                    m.groupname.toLowerCase().includes(searchText)
                );
            }
            ...
            for (let i = 0; i < pageItems.length; i++) {
                ...
                `);
                // <button class="btn btn-sm btn-danger boxx" onclick="prepareDelete(${m.groupId},'${m.groupname}')">ลบ</button>
            }
