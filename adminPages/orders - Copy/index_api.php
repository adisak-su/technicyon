...
<body class="sidebar-collapse">
                                            ...
                                            <tr>
                                                <td colspan="5">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-md-3 form-group position-relative">
                                                            <label for="orderTotal">ยอดรวมสุทธิ</label>
    ...
    <!-- <script src="fetchApi.js?<?php echo time(); ?>"></script> -->
    ...
    <script type="text/javascript">
        ...
        async function saveProductSale() {
            ...
            if (!validateRepairForm()) {
                sweetAlertError("กรุณาตรวจสอบข้อมูล!!!");
                return;
            }
            ...
            // window.open('print_receipt_hide.php?orderId=' + order.orderId, '_blank');
            window.open('print_receipt.php?orderId=' + order.orderId, '_blank');

            // if(data.success) {
            //         // ถ้าบันทึกสำเร็จ ให้เปิดหน้าพิมพ์ใบเสร็จ
            //         window.open('print_receipt.php?orderId=' + data.orderId, '_blank');
            //     } else {
