    ...
    <script type="text/javascript">
        ...
        $(document).ready(async function() {
            try {
                ...
                suppliers = await loadDataFromServer("supplier");
        ...
        async function syncDataRealtimeServer() {
            let dataExpires = [];
            try {
                dataExpires = await updateSyncData(["product","groupname","typename","supplier"]);
            } catch (error) {
                ...
                if (dataExpires.length) {
                    ...
                    dataExpires.forEach((item) => {
                        switch (item.tableName) {
                            case "product":
                                products = sortColumnData(item.data);
                                createFilterDataAndRender(currentPage);
                                break;
                            case "groupname":
