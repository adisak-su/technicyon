...
<body class="sidebar-collapse">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body" style="font-size: 1rem;">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-2 col-lg-2 col-xl-2 form-group">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="glass-card mb-2">
                            <form id="itemForm">
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-2 form-group position-relative mb-3">
                                        <input
                                            type="hidden"
                                            class="form-control"
                                            id="itemId_org"
    ...
    <script type="text/javascript">
        ...
        function saveItem() {
            ...
            if (!itemName || !itemAddress || !itemTelephone) {
            ...
            return new Promise(function(resolve, reject) {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status) {
                            resolve(data.couterId) // Resolve promise and when success
                        } else {
        ...
        function renderTable() {
            ...
            for (let i = 0; i < pageItems.length; i++) {
                ...
                `);
                // <button class="btn btn-sm btn-danger boxx" onclick="prepareDelete(${m.supplierId},'${m.name}')">ลบ</button>
            }
