...
<body class="hold-transition sidebar-mini dark-mode">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row disabled" id="rowProductSale">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input class="inputStyle inputStyleIcon cursorHand" type="text" id="searchProductID" list="optionProductID" onkeyup="dataFilterProductID();" onchange="setDataProductID(this.value);" autocomplete="off" placeholder="รหัสสินค้า">
    ...
    <script type="text/javascript">
        ...
        function setDataProductName(element) {
            let Product = allProduct.filter(item => item.name == element);
            if (Product.length) {
                $("#txtProductSaleID").val(Product[0].productid);
                $("#txtProductSaleName").val(Product[0].name);
        ...
        async function _setProductSale(item) {
            $("#txtProductSaleID").val(item.productid);
            $("#txtProductSaleName").val(item.name);
        ...
        async function editArrayProductSale(id) {
            for (index = 0; index < arrProductSale.length; index++) {
                if (arrProductSale[index].productID == id) {
        ...
        function showTableProductSale(arrayProductSale) {
            ...
            arrayProductSale.forEach(element => {
                ...
                myHTML += `<td style="vertical-align: middle;text-align:center;">
                            <button class="btn btn-warning" onclick="editArrayProductSale('${ID}');"><i class="far fa-edit"></i></button>
