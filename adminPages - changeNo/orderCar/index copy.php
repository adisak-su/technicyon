        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <label class="m-0 text-dark">ขายสินค้า</label>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <label for="listCustomerName" class="col-form-label">รายการสินค้า</label>
                                                    <div id="showListProduct">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                                ...
                                                <div class="card-header d-flex justify-content-between">
                                                    <div class="row">
                                                        <div class="col-12 d-flex justify-content-between">
                                                            <label class="mr-auto" style="line-height: 2.1rem">ลูกค้า</label>
                                                            <button class="btn btn-primary btn-2px" data-toggle="modal" data-target="#insertModal" data-table="Size" data-name="ขนาด">เพิ่มรายการ</button>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header d-flex justify-content-between">
                                                    <label class="mr-auto" style="line-height: 2.1rem">สินค้า</label>
                                                    <button class="btn btn-primary btn-2px" data-toggle="modal" data-target="#insertModal" data-table="Size" data-name="ขนาด">เพิ่มรายการ</button>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <label class="modal-title" id="optionModalLabel">เพิ่มรายการ</label>
    ...
    <script type="text/javascript">
        function setModal() {
            ...
            $('#optionModal').on('show.bs.modal', function(event) {
                ...
                var modal = $(this)
                modal.find('.modal-title').text('รายการสินค้า ' + txtName)
                modal.find('.modal-body #txtTable').val(txtTable);
                modal.find('.modal-body #txtID').val(txtID);
                modal.find('.modal-body #txtName').val(txtName);
            });
        ...
        function setListCustomer(result) {
            ...
            myHTML = `<select class="form-control form-select" aria-label="Default select example" onchange="customerSelected(this);">
            ...
            $("#showListCustomer").html(myHTML);
        }

        function setListProduct(result) {

            myHTML = `<select class="form-control form-select" aria-label="Default select example" onchange="productSelected(this);">
        ...
        function productSelected(_this) {
            element = _this;
            ID = element.value;
            name = element.options[element.selectedIndex].text;
            $("#productID").val(ID);
