...
<head>
    ...
    <title>ระบบจัดการช่างซ่อมรถยนต์ | <?php echo $shopName; ?></title>
...
<body class="sidebar-collapse">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <label class="mr-auto" style="line-height: 2.1rem">รายการรช่างซ่อมรถยนต์</label>
                                ...
                                <div class="card-body" style="font-size: 1rem;">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 col-lg-4 form-group">
                                            <label for="searchInput" class="form-label">ช่างซ่อมรถยนต์</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 form-group position-relative mb-3">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="itemName_org" />
                                        <label for="itemName" class="form-label">ช่างซ่อมรถยนต์</label>
                                        <div class="input-icon-wrapper">
    ...
    <script type="text/javascript">
        ...
        async function _loadAndSetData(storeName) {
            ...
            technicalNames = dataStore;
            // technicalNames = dataStore.map((item,index) => { return {"index":index , "colorname":item.colorname,"updatedAt":item.updatedAt}; });
        }
        ...
        function openEditModal(id) {
            editId = null;
            const m = technicalNames.find(x => x.technicalNo == id);
        ...
        function saveItem() {
            ...
            if (editId) {
                item.technicalNo = parseInt(editId);
        ...
        function confirmSave(item) {
            if (editId) {
                const index = technicalNames.findIndex(m => m.technicalNo == editId);
                if (index !== -1) {
                    technicalNames[index] = item;
                }
            } else {
        ...
        function confirmDelete(deleteId) {
            technicalNames = technicalNames.filter(m => m.technicalNo != deleteId);
            createFilterDataAndRender(currentPage);
        }
            ...
            for (let i = 0; i < pageItems.length; i++) {
                ...
                tbody.insertAdjacentHTML('beforeend', `
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-around">
                                <button class="btn btn-sm btn-warning boxx text-white" onclick="openEditModal(${m.technicalNo})">แก้ไข</button>
        ...
        async function syncDataRealtime() {
            ...
            if (tableNames) {
                if (tableNames.find((item) => item == "technicalnames")) {
                    let dataSource = await loadDataFromDB("technicalnames");
                    technicalNames = sortColumnData(dataSource);
                    createFilterDataAndRender(currentPage);
                }
        ...
        async function _syncDataRealtime() {
            let dataSource = await updateSyncData({
                dataName: "technicalnames"
            });
            if (dataSource) {
                technicalNames = dataSource;
                createFilterDataAndRender();
            }
        }
        ...
        //         if(statusChange.tableNames.find(item => item == "technicalnames")) {
        //             technicalNames = await loadDataFromDB("technicalnames");
        //             createFilterDataAndRender();
        //         }
        //     }
        // }
