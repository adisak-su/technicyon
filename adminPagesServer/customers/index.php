...
<head>
    ...
    <title>ระบบจัดการลูกค้า | <?php echo $shopName; ?></title>
...
<body class="sidebar-collapse">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <label class="m-0 text-dark">จัดการลูกค้า</label>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <label class="mr-auto" style="line-height: 2.1rem">รายการลูกค้า</label>
                                ...
                                <div class="card-body" style="font-size: 1rem;">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 col-lg-4 form-group">
                                            <label for="searchInput" class="form-label">รหัส/ชื่อลูกค้า</label>
                                        ...
                                        <table class="table table-bordered table-striped align-middle">
                                            <thead class="table-primary">
                                                <tr>
                                                    ...
                                                    <th style="min-width: 50px;" onclick="sortColumnBy('customerId',this);">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="glass-card mb-2">
                            <form id="itemForm">
                                <div class="row">
                                    <div class="col-12 col-md-3 form-group position-relative mb-3">
                                        <input
                                            type="hidden"
                                            class="form-control"
                                            id="itemId_org"
                                            placeholder="รหัสลูกค้า..." />
                                        <label for="itemId" class="form-label">รหัสลูกค้า</label>
                                        <div class="input-icon-wrapper">
                                            <i class="fa fa-keyboard input-icon" aria-hidden="true"></i>
                                            <input
                                                type="text"
                                    ...
                                    <div class="col-6 form-group position-relative mb-3">
                                        <label for="itemType" class="form-label">ประเภท</label>
                                        <div class="input-icon-wrapper">
                                            <i class="fa fa-keyboard input-icon"></i>
                                            <input
                                                type="text"
    ...
    <script type="text/javascript">
        ...
        function openEditModal(id) {
            editId = null;
            const m = customers.find(x => x.customerId == id);
        ...
        function confirmSave(item) {
            if (editId) {
                const index = customers.findIndex(m => m.customerId == editId);
                if (index !== -1) {
        ...
        function createFilterDataAndRender(page = 1) {
            ...
            if (searchText) {
                filtered = filtered.filter(m =>
                    m.customerId.toLowerCase().includes(searchText) || m.name.toLowerCase().includes(searchText)
                );
            }
            ...
            for (let i = 0; i < pageItems.length; i++) {
                ...
                tbody.insertAdjacentHTML('beforeend', `
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-around">
                                <button class="btn btn-sm btn-warning boxx text-white" onclick="openEditModal('${m.customerId}')">แก้ไข</button>
        ...
        $(document).ready(async function() {
            try {
                ...
                customers = await loadDataFromServer("customer")
                createFilterDataAndRender();
                loaderScreen("hide");
            } catch (error) {
                loaderScreen("hide");
        ...
        async function syncDataRealtimeServer() {
            let dataExpires = [];
            try {
                dataExpires = await updateSyncData(["customer"]);
            } catch (error) {
                ...
                if (dataExpires.length) {
                    ...
                    dataExpires.forEach((item) => {
                        switch (item.tableName) {
                            case "customer":
                                customers = sortColumnData(item.data);
                                createFilterDataAndRender(currentPage);
                                break;
                        }
                    });
