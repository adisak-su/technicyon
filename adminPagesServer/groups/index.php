...
<body class="sidebar-collapse">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <label class="mr-auto" style="line-height: 2.1rem">รายการยี่ห้อ/รุ่นรถยนต์</label>
                                ...
                                <div class="card-body" style="font-size: 1rem;">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 col-lg-4 form-group">
                                            <label for="searchInput" class="form-label">ยี่ห้อ/รุ่นรถยนต์</label>
    ...
    <script type="text/javascript">
        ...
        async function syncDataRealtimeServer() {
            let dataExpires = [];
            try {
                dataExpires = await updateSyncData(["groupname"]);
            } catch (error) {
                ...
                if (dataExpires.length) {
                    ...
                    dataExpires.forEach((item) => {
                        switch (item.tableName) {
                            case "groupname":
                                groupNames = sortColumnData(item.data);
                                createFilterDataAndRender(currentPage);
                                break;
                        }
                    });
