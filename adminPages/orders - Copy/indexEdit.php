        ...
        <div class="content-wrapper">
            <div class="content-header">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <label class="m-0 text-dark">แก้ไขรายการขายสินค้าหน้าร้าน</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        */
        ...
        function saveOrderToOrders(order) {
            ...
            if(resultIndex >= 0) {
                ...
                orders.push({orderId:order.orderId, customerId:order.customerId, mydate:order.orderDate, nettotal:order.total})
            }
        }
        ...
        function resetValueSale() {
            ...
            //orderDateFlatpickr.setDate("today");
        ...
        async function loadAndSetData(storeName) {
            ...
            if (storeName == "products") {
                ...
                // setupAutocompleteOnFocus(
                //     "filterCustomerModal", "filterCustomerModalSuggestions", customers, "customerId", ["customerId", "name"], ["customerId", "name"], dataFilterOrderModal);
