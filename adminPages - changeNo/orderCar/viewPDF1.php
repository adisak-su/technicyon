...
$fileNamePrint = $locationOrder . $_REQUEST["fileName"];
?>
                        ...
                        <div class="col-12">
                            <div class="card" >
                                <div class="card-header d-flex justify-content-between">
                                    <div class="mr-auto my-font-size" style="line-height: 2.1rem">ใบส่งของชั่วคราว</div>
                                    <!-- <button type="button" class="btn btn-success" id="print" data-id="${ID}" style="float: left;" onclick="printDocument('pdfDocument');">
                                        <i class="fa fa-print"></i>
                                    </button> -->
                                    <!-- <button type="button" class="mr-auto btn btn-success btn-25px" style="float: center;" onclick="printJS({printable: '<?php echo $fileNamePrint; ?>', type: 'pdf', base64: true})">
                                        พิมพ์ 64
                                    </button> -->
                                    <button type="button" class="mr-auto btn btn-success btn-25px" style="float: center;" onclick="printJS('<?php echo $fileNamePrint; ?>')">
                                        พิมพ์
                                    </button>
                                    <a href="index.php" class="btn btn-warning btn-sm btn-25px">กลับ</a>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12 center">
                                            <embed type="application/pdf" src="<?php echo $fileName; ?>" id="pdfDocument" width="100%" height="700px">
                                            </embed>
                                        </div>
                                    </div>
                                </div>
