...
<body>
<div class="my-3 width-block" >
   <button class="btn width-block btn-primary" data-bs-toggle="modal" data-bs-target="#productModal" onclick="openAddModal()">
...
<div class="container-fluid my-3" >
    <div class="row row-cols-4 row-cols-sm-6 row-cols-md-12 row-cols-lg-12 g-3">
        <!-- เมนูที่ 1 -->
        <div class="col">
            <a href="#" class="text-decoration-none">
                <div class="menu-item shadow text-center h-100">
...
<div>
    <div class="row row-cols-4 row-cols-sm-6 row-cols-md-6 g-4">
        <!-- เมนูที่ 1 -->
        <div class="col">
            <a href="#" class="text-decoration-none">
                <div class="menu-item shadow text-center h-100">
    ...
    <script>
        ...
        function openAddModal() {
            ...
            if ($('#editMode').val() === 'add') {
                ...
                //const nextId = products.length > 0 ? parseInt(p.productId.substring(2))
                ...
                //alert(sortArray[sortArray.length-1].productId);
                const nextId = products.length > 0 ? parseInt(sortArray[sortArray.length-1].productId.substring(2)) + 1 : 1;
                //alert(nextId);
                $('#productId').val(`PD${nextId.toString().padStart(5, '0')}`);
            }
