    ...
    <div class="container">
        ...
        <div class="receipt">
            ...
            <div class="order-info">
                <div>
                    <strong>เลขที่ใบเสร็จ:</strong> <span id="orderId">F202524855</span>
                </div>
                <div>
                    <strong>วันที่:</strong> <span id="orderDate">2025-06-19</span>
                </div>
            </div>
            
            <div class="customer-info">
                <p><strong>ชื่อลูกค้า:</strong> <span id="customerName">บริษัทคม ฐาน ๙ รถยนต์ จำกัด # 0105551095117_สนญ.</span></p>
                <p><strong>ที่อยู่:</strong> <span id="customerAddress">6/3,6/4 ถ.กาญจนาภิเษก แขวงรามอินทรา เขตคันนายาว กทม.10230 # 0105551095117</span></p>
                <p><strong>โทรศัพท์:</strong> <span id="customerTelephone">0897991784</span></p>
            </div>
            ...
            <table class="items-table">
                ...
                <tbody id="orderItems">
                    <tr>
                        <td>1</td>
                        <td>AIR-BAG Nissan - นีโอ # B55544M426</td>
                        <td>4,830.00</td>
                        <td>1</td>
                        <td>4,830.00</td>
                    </tr>
            ...
            <div class="total-section">
                <p>รวมทั้งหมด: <span id="partsTotal">5,190.00</span> บาท</p>
                <p>ภาษีมูลค่าเพิ่ม (7%): <span id="vatValue">363.30</span> บาท</p>
                <p>รวมสุทธิ: <span id="total">5,553.30</span> บาท</p>
            </div>
