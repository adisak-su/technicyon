                        ...
                        <div class="card-body" style="font-size: 1rem;">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-12 col-md-2 form-group position-relative">
                                    ...
                                    <div class="input-icon-wrapper-after" style="max-width:180px;">
                                            <div class="input-icon">📅</div>
                                            <input type="text" id="orderDate" class="form-control" value="" placeholder="" readonly autocomplete="off">
                                        </div>
                                </div>
                                <div class="col-12 col-md-3 form-group position-relative">
                                    <label for="orderDate1" class="d-block">วันที่</label>
                                    <div class="d-flex justify-content-start">
                                        <div class="input-icon-wrapper-after" style="max-width:180px;">
                                            <div class="input-icon">📅</div>
                                            <input type="text" id="orderDate1" class="form-control" value="" placeholder="" readonly autocomplete="off">
                                        </div>
                                        <button class="btn btn-outline-danger" type="button" id="reset-btn">ลบ</button>
                                    </div>
                                </div>
                                <div class="col-12 col-md-2 form-group position-relative">
                                    <label for="orderDate1" class="d-block">วันที่</label>
                                    <div class="input-icon-wrapper-after" style="width:150px;">
                                        <i class="far fa-calendar alt input-icon" aria-hidden="true"></i>
                                        <input type="text" id="orderDate1" class="input-FlatPicker" value="" placeholder="" autocomplete="off">
                                    </div>
                                    <button class="btn btn-outline-danger" type="button" id="${displaySelector}_clear-btn">ลบ</button>
                                </div>
                                <div class="col-12 col-md-2 form-group position-relative">
                                    <label for="orderDate1" class="d-block">วันที่</label>
                                    <i class="far fa-calendar alt input-icon" aria-hidden="true"></i>
                                    <input type="text" id="orderDate1" class="" value="" placeholder="" autocomplete="off">
